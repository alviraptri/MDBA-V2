                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Edit BKB Supplier</h4>
                                </div>
                                <div class="card-content">
                                    <div class="card-body">
                                        ...
                                        ?>
                                        <form class="form" action="<?php echo base_url('inventSupp/simpanEditBkb'); ?>" method="POST">
                                            <div class="row">
                                                <div class="col-md-4 col-12">
                                                    <div class="form-group">
                                                        <label for="first-name-column">No. BKB</label>
                                                        <input type="text" id="idBkbOld" class="form-control" name="bkbOld" readonly value="<?= $szDocId; ?>">
                                                    </div>
                                                </div>
                                                <div class="col-md-4 col-12">
                                                    <div class="form-group">
