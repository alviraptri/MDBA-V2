...
<head>
    ...
    <title>MDBA - SALDO KAS SEMENTARA</title>
                            ...
                            <nav aria-label="breadcrumb" class='breadcrumb-header'>
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">
                                        <a href="<?php echo base_url('home/cashierSettlement'); ?>">Saldo Kas Sementara</a>
                                    </li>
                                </ol>
                            </nav>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Saldo Kas Sementara</h4>
                                </div>
                                <div class="card-content">
                                    <div class="card-body">
                                        ...
                                        ?>
                                        <form class="form" action="<?php echo base_url('cashierSettlement/simpan'); ?>" method="POST">
                                            <div class="row">
                                                <div class="col-md-3 col-12">
                                                    <div class="form-group">
                                                        <label for="first-name-column">Perusahaan</label>
                                                        <input type="text" id="idComp" class="form-control" name="comp" readonly value="<?= $company .' - '. $companyName;?>">
                                                        <input type="hidden" id="idPerusahaan" class="form-control" name="perusahaan" readonly value="<?= $company; ?>">
                                                    </div>
                                                </div>
                                                <div class="col-md-3 col-12">
                                                    <div class="form-group">
                                                        <label for="first-name-column">Depo</label>
                                                        <input type="text" id="idBranch" class="form-control" name="branch" readonly value="<?= $branch .' - '. $branchName;?>">
                                                        <input type="hidden" id="idDepo" class="form-control" name="depo" readonly value="<?= $branch; ?>">
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-6" style="padding-right: 0">
                                                                <input type="date" id="idTglStart" class="form-control" name="tglStart" value="<?= date('Y-m-d'); ?>">
                                                            </div>
                                                            <div class="col-6" style="padding-right: 0">
                                                                <input type="date" id="idTglFinish" class="form-control" name="tglFinish" value="<?= date('Y-m-d'); ?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
