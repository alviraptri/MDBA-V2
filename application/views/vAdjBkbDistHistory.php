...
<head>
    ...
    <title>MDBA - BKB DISTRIBUSI ADJUSTMENT HISTORY</title>
...
<body>
                ...
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last">
                            <h3>BKB Adjustment Distribusi History</h3>
                        </div>
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class='breadcrumb-header'>
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="<?php echo base_url('home'); ?>">Dashboard</a></li>
                                    <li class="breadcrumb-item active" aria-current="page"><a href="<?php echo base_url('inventDist/historyAdjBkb'); ?>">Adjustment History</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                        ...
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col-md-6" style="float: right;">
                                    <form action="<?php echo base_url('inventDist/tglHistAdjBkb') ?>" method="post">
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-full" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel20">Detail Histroy Adjustment BKB Distribusi</h4>
    ...
    <script>
        function detail(x) {
            ...
            function data() {
                $.ajax({
                    url: "<?= base_url('inventDist/detailBkbAdj') ?>",
                    method: "POST",
                    data: {
                        'id': id
                    },
