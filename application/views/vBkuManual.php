...
<head>
    ...
    <title>MDBA - BUKTI KELUAR UANG (BTU)</title>
...
<body>
                            ...
                            <nav aria-label="breadcrumb" class='breadcrumb-header'>
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">
                                        <a href="<?php echo base_url('home/cashierBKU'); ?>">Bukti Keluar Uang (BKU)</a>
                                    </li>
                                </ol>
                            </nav>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Tambah Bukti Keluar Uang (BKU)</h4>
                                </div>
                                <div class="card-content">
                                    <div class="card-body">
                                        <form class="form" action="<?php echo base_url('cashierBku/simpanBku'); ?>" method="POST">
                                            <div class="row">
                                                <div class="col-md-3 col-12">
                                                    <div class="form-group">
                                                        <label for="first-name-column">No. BKU</label>
                                                        <input type="text" id="idBku" class="form-control" name="bku" readonly value="<?= $bku; ?>">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12 d-flex justify-content-end">
                                                    ...
                                                    <a href="<?php echo base_url('home/cashierBku') ?>">
    ...
    <script type="text/javascript">
        ...
        function getFormAkunHead() {
            ...
            $.ajax({
                url: "<?= base_url('cashierBku/getAccountName') ?>",
                method: "POST",
                data: {
                    id: id
                },
        ...
        function getFormSubAkunDet(x) {
            ...
            $.ajax({
                url: "<?= base_url('cashierBku/getSubAccName') ?>",
                method: "POST",
                data: {
                    id: id
                },
