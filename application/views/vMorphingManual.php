...
<body>
                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <form class="form" action="<?php echo base_url('inventMorphing/simpan'); ?>" method="POST">
                                            <div class="row">
                                                <div class="col-md-6 col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="hidden" id="hidden" class="form-control" name="noRef" readonly value="-">
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-12">
                                                    <div class="form-group">
                                                    ...
                                                    <table class='table table-striped'>
                                                        ...
                                                        <tbody id="table_body" class="view-this">
                                                                ...
                                                                <tr id="baris0">
                                                                    ...
                                                                    <td>
                                                                        <input id="userName-2a" name="qty[]" type="text" id="qty0" value="" class="form-control" onkeypress="return hanyaAngka(event)">
                                                                        <input name="satuan[]" type="hidden" id="idSatuan0" class="form-control">
                                                                    </td>
                                                                    <td>></td>
                                                                    <td>
                                                                        <select class="js-example-basic-single form-select" name="produkTo[]" id="idProdukTo0" onchange="getFormProdukTo(0)">
                                                                            <option value="-" disabled>Pilih Produk</option>
                                                                            <?php
                                                                            foreach ($produk as $value) {
                                                                                ?>
                                                                    ...
                                                                    <td>
                                                                        <input id="userName-2a" name="qtyTo[]" type="text" id="qty0" value="" class="form-control" onkeypress="return hanyaAngka(event)">
                                                                        <input name="satuanTo[]" type="hidden" id="idSatuanTo0" class="form-control">
                                                                    </td>
                                                                    <td>
                                                                    <button type="button" onclick="loadnew()" id="btn-tambah-form" class="btn btn-primary">+</button>
                                                                    </td>
                                                                </tr>
                                                        </tbody>
                                                    </table>
    ...
    <script type="text/javascript">
        ...
        function loadnew() {
            ...
            cols += "<td>" + (counter+1) + "<input type='hidden' id='counter' value='" + counter + "'></td>";
            cols += "<td>";
            cols += "<select class='js-example-basic-single form-select' name='produk[" + counter + "]' id='idProduk" + counter + "' onchange='getFormProduk("+counter+")'>";
            ...
            cols += "<input name='satuan["+counter+"]' type='hidden' id='idSatuan"+counter+"' class='form-control'>";
            cols += "</td>";
            cols += "<td>></td>";
            cols += "<td>";
            cols += "<select class='js-example-basic-single form-select' name='produkTo[" + counter + "]' id='idProdukTo" + counter + "' onchange='getFormProdukTo("+counter+")'>";
            cols += "<option value='-' disabled>Pilih Produk</option>";
            cols += "<?php foreach ($produk as $value) { ?>";
            cols += "<option value='<?= $value->szId; ?>'><?= $value->szId; ?> - <?= $value->szName; ?></option>";
            cols += "<?php } ?>";
            ...
            cols += "<input name='satuanTo["+counter+"]' type='hidden' id='idSatuanTo"+counter+"' class='form-control'>";
            cols += "</td>";
            cols += "<td>";
            cols += "<button onclick='deleteRow(" + counter + ")' class='btn btn-danger'>-</button>";
            cols += "</td>";
            cols += "</tr>";
