...
<head>
    ...
    <title>BKB DISTRIBUSI <?= $document; ?></title>
    <style>
        #table {
...
<body>
    ...
    <div style="text-align:center">
        <h3> BUKTI KELUAR BARANG ANTARDEPO</h3>
    </div>
    <?php
    foreach ($load as $value) {
        $gudang = $value->warehouseName;
        $pengemudi = $value->szEmployeeId . ' - ' . $value->employeeName;
        $kendaraan = $value->szVehicleId . ' - ' . $value->vehicleName;
