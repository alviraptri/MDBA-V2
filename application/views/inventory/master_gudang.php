...
<div class="main-content container-fluid">
    ...
    <section class="section">
        <div class="card">
            ...
            <?php echo $this->session->flashdata('massage');?>
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <a href="<?= base_url()?>master?id=3">NEW FORM</a>  
                    </div>
                    <div class=" col-sm-3 text-right">
                        <select style="float:right;" name="statusGudang" class="form-select  " id="filterGudang">
            ...
            <div class="card-body">
                <table class='table table-striped' id="gudang">
                    <thead>
                        <tr>
                            <th>NO</th>
                            <th>ID Gudang</th>
       ...
       <?php foreach ($tipe as $d){?>
                                        ...
                                        <div class="modal fade text-left" id="large<?=$d->szId;?>"  role="dialog"
                                            ...
                                            <div class="col">
                                                <div class="form-group">                                                <label for="">DEPO</label>    
                                                <div id="szDescriptionTipe">
                                                <input type="text" readonly name="depo" value="<?= $d->depo_nama;?>" id="" class="form-control">
                                                </div>
                                            </div>
                                         </div>
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <div id="szDescriptionTipe">
                                                <textarea readonly name="Ketgudang" class="form-control" id="" cols="30" rows="3"><?=$d->szDescription;?></textarea>
                                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input required type="text" disabled value="<?= $d->szPhone1;?>" name="szZipCode" id="" class="form-control">
                                        ...
                                        <input required type="text" disabled value="<?= $d->szPhone2;?>" name="szZipCode" id="" class="form-control">
                                    ...
                                    <div class="col-sm">
                                        ...
                                        <input required type="text" disabled value="<?= $d->szPhone3;?>" name="szZipCode" id="" class="form-control">
                                    </div>
                                    </div>
                                </div>          
                                <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                            ...
                                            <input required type="text" disabled value="<?= $d->szFaximile;?>" name="szZipCode" id="" class="form-control">
                                        </div> 
                                    </div> 
             ...
             <div class="modal fade text-left" id="update<?= $d->szId;?>"  role="dialog" aria-labelledby="myModalLabel17" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg"
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                        <form action="<?= base_url();?>master/updateGudang" method="post">
                                            ...
                                            <div class="col">
                                                <div class="form-group">
                                                    <label for="first-name-column">Kode Gudang</label>
                                                    <input disabled  type="text" id="szIdTipe" value="<?=$d->szId;?>" class="form-control" name="Kgudang">
                                                </div>
                                            </div>
                                            <div class="col">
                                                <div class="form-group">
                                                    <label for="last-name-column">Nama Gudang</label>
                                                    <input required type="text" id="szNameTipe" value="<?=$d->szName;?>" class="form-control" name="Ngudang">
                                                </div>
                                            </div>
                                            <div class="col">
                                            <div class="form-group">
                                                ...
                                                <div id="szDescriptionTipe">
                                                           <select required name="depo" id="depo_select<?= $d->szId;?>" class="form-control">
                                                            <option value="<?= $d->kode_dms?>"><?= $d->depo_nama;?> </option>

                                                         <?php foreach ($depo as $s){?>
                                                        <option value="<?= $s->kode_dms?>"><?= $s->depo_nama;?> </option>
                                                            <?php }?>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group">
                                            <label for="">Keterangan</label>    
                                            <div id="szDescriptionTipe">
                                                <textarea required name="Ketgudang" class="form-control" id="" cols="30" rows="3"><?=$d->szDescription;?></textarea>
                                            </div>
                                        </div>
                                            <!-- <textarea name="" class="form-control" id="szDescription" cols="30" rows="5"></textarea> -->
                            ...
                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <label for="first-name-column">Alamat</label>
                                                    <?php if($d->szAddress != null ){?>
                                                    <textarea  type="text" id="first-name-column" class="form-control" required name="alamat"><?= $d->szAddress;?></textarea>
                                                    <?php }else{?>
                                                 <textarea  type="text" id="first-name-column" class="form-control" name="alamat"><?= $d->szAddress;?></textarea>
                                                    <?php }?>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="col-md-6 col-12">
                                            ...
                                            <select name="szProvince" id="Provinsi<?= $d->szId;?>" onchange="getFormKota<?= $d->szId;?>()"  class="    form-control" id="">
                                            ...
                                            <div class="col-md-6 col-12">
                                                ...
                                                <select onchange="getFormKecamatan<?=$d->szId;?>()" name="szCity" class=" form-control" id="idkota<?=$d->szId;?>" >
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <label> Kecamatan </label>
                                                    <br>
                                                    <select onchange="getFormKelurahan<?=$d->szId;?>()" name="szDistrict" id="idkecamatan<?=$d->szId;?>" class="form-control" >
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                                ...
                                                <?php if($d->szFaximile != null ){?>
                                                    <input type="number"  required value="<?= $d->szFaximile;?>" name="test" id="" class="form-control">
                                                <?php }else{?>
                                                        <input type="number"   value="<?= $d->szFaximile;?>" name="test" id="" class="form-control">
                                    ...
                                    <div class="col-sm-12">
                                     <div class="form-group">
                                        <label for="">Email</label>
                                            ...
                                            <input type="email" required  value="<?= $d->szEmail;?>" name="szEmail" id="" class="form-control">
                                            <?php }else{?>
                                                <input type="email"  value="<?= $d->szEmail;?>" name="szEmail" id="" class="form-control">
                                        ...
                                        <div class="modal fade text-left" id="hapus<?= $d->szId;?>"  role="dialog" aria-labelledby="myModalLabel17" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-sm"
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="row">
                                                            <div class="col">
                                                              <form action="<?= base_url();?>master/hapusGudang" method="post">          
                    ...
                    <script src="<?= base_url();?>assets/js/gudang.js"></script>
<script>
