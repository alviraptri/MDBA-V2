...
<head>
    ...
    <title>MDBA - KONVERSI PPN INVOICE</title>
        ...
        <div id="main">
            ...
            <div class="main-content container-fluid">
                            ...
                            <nav aria-label="breadcrumb" class='breadcrumb-header'>
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">
                                        <a href="<?php echo base_url('home/konversiInvoice'); ?>">Konversi PPN Invoice</a>
                                    </li>
                                </ol>
                            </nav>
                        </div>
                ...
                <section class="section">
                    <div class="card">
                        <div class="card-body">
                            <form method="POST" action="<?php echo base_url('konversi/updateInvoice'); ?>">
                                <div class="row">
                                    <div class="col-md-5 col-12">
                                        <div class="form-group">
                                            <label for="last-name-column" style="font-weight: bold;">No. Invoice</label>
                                            <br>
                                            <label for="dari">Dari</label>
                                            <input type="text" name="invoiceFr" id="idInvoiceFr" class="form-control" placeholder="336-0000000" value="<?= $this->session->userdata('user_branch'); ?>-" autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="col-md-5 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="invoiceTo" id="idInvoiceTo" class="form-control" placeholder="336-0000000" value="<?= $this->session->userdata('user_branch'); ?>-" autocomplete="off">
                                        </div>
                                    </div>
                                ...
                                <table class='table table-striped' width="100%">
                                    <thead>
                                        <tr>
                                            <th rowspan="2" style="text-align: center; width: 17%;">No. Invoice</th>
                                            <th rowspan="2" style="text-align: center;">Dec Amount</th>
                                            <th rowspan="2" style="text-align: center;">TAX/PPN</th>
...
<script>
    ...
    function filter() {
        var invoiceFr = document.getElementById('idInvoiceFr').value;
        var invoiceTo = document.getElementById('idInvoiceTo').value;

        $.ajax({
            url: "<?= base_url('konversi/getDataInvPPN') ?>",
            method: "POST",
            data: {
                'invoiceFr': invoiceFr,
                'invoiceTo': invoiceTo
            ...
            success: function(data) {
                ...
                if (data.length == '0') {
                    ...
                    for (i = 0; i < data.length; i++) {
                        if (data[i].decTaxRate == '10.0000') {
                            var taxRate = '10%';
                        } else {
                            var taxRate = '11%';
                        }
                        let tax = parseFloat(data[i].ppn);
