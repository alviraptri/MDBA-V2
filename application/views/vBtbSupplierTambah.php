...
<body>
                                    ...
                                    <div class="row d-flex justify-content-center">
                                        <div class="col-12">
                                            <div class="wizard">
                                                ...
                                                <form role="form" action="<?php echo base_url('inventSupp/simpanHistoryBtb'); ?>" method="POST" class="login-box" enctype="multipart/form-data">
                                                    <div class="tab-content" id="main_form">
                                                        <?php
                                                        $row = count($data);
                                                        foreach ($data as $value) {
                                                            $mk_po = $value->po_po_old;
                                                        ...
                                                        <div class="tab-pane" role="tabpanel" id="step4">
                                                            ...
                                                            if ($mk_dn_t != '') { ?>
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-8">
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-7">
                                                                                <input type="text" name="noDnTk" id="noDnTk" style="font-size: 22px; font-weight: bold;" class="col-6 form-control" readonly value="<?= $mk_dn_t ?>">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-2"></div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="form-group col-md-4">
                                                                        <label for="firstName">Produk</label>
                                                                        <input type="text" name="produkDepoDnTk" id="produkDnDepoTk" class="form-control" readonly value="<?= $value->material_nama ?>">
                                                                    </div>
                                                                    <div class="form-group col-md-2">
                                                                        <label for="firstName">Qty</label>
                                                                        <input type="text" name="qtyDepoDnTk" id="qtyDnDepoTk" class="form-control" readonly value="<?= $value->mk_dn_t_qty ?>">
                                                                    </div>
                                                                    <div class="form-group col-md-4">
                                                                        <label for="firstName">Produk</label>
                                                                        <input type="text" name="produkAdmDnTk" id="produkDnAdmTk" class="form-control" value="<?= $value->material_nama ?>" readonly>
                                                                    </div>
                                                                    <div class="form-group col-md-2">
                                                                        <label for="firstName">Qty</label>
                                                                        <input type="number" name="qtyAdmDnTk" id="qtyDnAdmTk" class="form-control" value="<?= $value->mk_dn_t_qty ?>" readonly>
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-3"></div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="form-group col-md-3">
                                                                        ...
                                                                        <input type="text" name="glnKsgAqDepo" id="glnKsgAqDepo" class="form-control" readonly value="<?= (int)$value->ksg_total ?>">
                                                                    </div>
                                                                    <div class="form-group col-md-3">
                                                                        <label for="firstName">Gallon Isi Aqua</label>
                                                                        <input type="text" name="glnIsiAqDepo" id="glnIsiAqDepo" class="form-control" readonly value="<?= (int)$value->isi_total ?>">
                                                                    </div>
                                                                    <div class="form-group col-md-3">
                                                                        <label for="firstName">Gallon Kosong Aqua</label>
                                                                        <input type="number" name="glnKsgAqAdm" id="glnKsgAqAdm" class="form-control" readonly value="<?= (int)$value->ksg_total ?>">
                                                                    </div>
                                                                    <div class="form-group col-md-3">
                                                                        <label for="firstName">Gallon Isi Aqua</label>
                                                                        <input type="number" name="glnIsiAqAdm" id="glnIsiAqAdm" class="form-control" readonly value="<?= (int)$value->isi_total ?>">
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="form-group col-md-3">
                                                                        <label for="firstName">Gallon Kosong Vit</label>
                                                                        <input type="text" name="glnKsgVtDepo" id="glnKsgVtDepo" class="form-control" readonly value="<?= (int)$value->ksg_total ?>">
                                                                    </div>
                                                                    <div class="form-group col-md-3">
                                                                        <label for="firstName">Gallon Isi Vit</label>
                                                                        <input type="text" name="glnIsiVtDepo" id="glnIsiVtDepo" class="form-control" readonly value="<?= (int)$value->isi_total ?>">
                                                                    </div>
                                                                    <div class="form-group col-md-3">
                                                                        <label for="firstName">Gallon Kosong Vit</label>
                                                                        <input type="number" name="glnKsgVtAdm" id="glnKsgVtAdm" class="form-control" readonly value="<?= (int)$value->ksg_total ?>">
                                                                    </div>
                                                                    <div class="form-group col-md-3">
                                                                        <label for="firstName">Gallon Isi Vit</label>
                                                                        <input type="number" name="glnIsiVtAdm" id="glnIsiVtAdm" class="form-control" readonly value="<?= (int)$value->isi_total ?>">
                                                                    </div>
                                                                </div>
                                                            <?php
                                                            }
                                                        ...
                                                        <div class="tab-pane" role="tabpanel" id="step5">
                                                            <div class="all-info-container">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-8">
                                                                        <div class="form-group row">
                                                                            <label class="col-2 col-form-label" for="btb" style="font-size: 22px; font-weight: bold;">BTB</label>
                                                                            <div class="col-10">
                                                                                <input type="text" name="btb" id="idBtb" style="font-size: 22px; font-weight: bold;" class="col-6 form-control" readonly value="<?= $btb; ?>">
                                                                    ...
                                                                    <div class="form-group col-md-12">
                                                                        <table class='table table-striped'>
                                                                            ...
                                                                            <tbody id="table_body">
                                                                                ...
                                                                                $no = 0;
                                                                                foreach ($data as $key) {
                                                                                    if ($key->mk_dn_m_qty != '0') {
                                                                                        if ($key->masterKode == '74559G' || $key->masterKode == '74560G' || $key->masterKode == '19310' || $key->masterKode == '74559' || $key->masterKode == '74560') {
                                                                                ?>
                                                                                            <tr>
                                                                                                <td>
                                                                                                ...
                                                                                                <td>
                                                                                                    <input name="qty[<?= $no; ?>]" type="text" id="idQty<?= $no; ?>" class="form-control" onkeypress="return hanyaAngka(event)" autocomplete="off" value="<?= $key->mk_dn_m_qty; ?>" onchange="getBa(<?= $no; ?>)" required>
                                                                                                    <input name="qtyOld[<?= $no; ?>]" type="hidden" id="idQtyOld<?= $no; ?>" class="form-control" onkeypress="return hanyaAngka(event)" autocomplete="off" value="<?= $key->mk_dn_m_qty; ?>">
                                                                                                </td>
                                                                                                <td>
                                                                                                    <?php
                                                                                                    foreach ($product as $prod) {
                                                                                    ...
                                                                                    if ((int)$key->mk_jugrack != '0') {
                                                                                        if ($key->masterKode == '33300') {
                                                                                        ?>
                                                                                            <tr>
                                                                                                <td>
                                                                                                    <select class="js-example-basic-single form-select" name="kode[<?= $no; ?>]" id="idKode<?= $no; ?>" required onchange="getFormProduk(<?= $no; ?>)">
                                                                                                ...
                                                                                                <td>
                                                                                                    <input name="qty[<?= $no; ?>]" type="text" id="idQty<?= $no; ?>" class="form-control" onkeypress="return hanyaAngka(event)" autocomplete="off" value="<?= (int)$key->mk_jugrack; ?>" required onchange="getBa(<?= $no; ?>)">
                                                                                                    <input name="qtyOld[<?= $no; ?>]" type="hidden" id="idQtyOld<?= $no; ?>" class="form-control" onkeypress="return hanyaAngka(event)" autocomplete="off" value="<?= (int)$key->mk_jugrack; ?>">
                                                                                                </td>
                                                                                                <td>
                                                                                                    <?php
                                                                                                    foreach ($product as $prod) {
                                                                ...
                                                                if ($mk_dn_t != '0') { ?>
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-8">
                                                                            <div class="form-group row">
                                                                                <label class="col-5 col-form-label" for="btb" style="font-size: 22px; font-weight: bold;">BTB Tolakan</label>
                                                                                <div class="col-7">
                                                                                    <input type="text" name="btbTk" id="idBtbTk" style="font-size: 22px; font-weight: bold;" class="col-6 form-control" readonly value="<?= $btbTk; ?>">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-2"></div>
                                                                            ...
                                                                            <table class='table table-striped'>
                                                                                ...
                                                                                <tbody id="table_body">
                                                                                    ...
                                                                                    foreach ($data as $key) {
                                                                                        ...
                                                                                        if ($key->isi_total != '0') {
                                                                                            if ($key->masterKode == '41001' || $key->masterKode == '41013') { ?>
                                                                                                <tr>
                                                                                                    <td>
                                                                                                        <select class="js-example-basic-single form-select" name="kodeTk[<?= $no; ?>]" id="idKodeTk<?= $no; ?>" required onchange="getFormProdukTk(<?= $no; ?>)">
                                                                                                            <option value="-" disabled>Pilih Produk</option>
                                                                                                            <?php
                                                                                                            foreach ($product as $prod) {
                                                                                                                if ($prod->szId == $key->masterKode) { ?>
                                                                                                    ...
                                                                                                    <td>
                                                                                                        ...
                                                                                                        foreach ($product as $prod) {
                                                                                                            if ($prod->szId == $key->masterKode) { ?>
                                                                                                                <input name="produkTk[<?= $no; ?>]" type="text" id="idProdukTk<?= $no; ?>" class="form-control" readonly value="<?= $prod->szName; ?>">
                                                                                                        <?php
                                                                                                            }
                                                                                                        }
                                                                                                        ?>
                                                                                                    ...
                                                                                                    <td>
                                                                                                        <input name="qtyTk[<?= $no; ?>]" type="text" id="idQtyTk<?= $no; ?>" class="form-control" onkeypress="return hanyaAngka(event)" autocomplete="off" value="<?= $key->isi_total; ?>" required onchange="getBa(<?= $no; ?>)">
                                                                                                        <input name="qtyOldTk[<?= $no; ?>]" type="hidden" id="idQtyOldTk<?= $no; ?>" class="form-control" onkeypress="return hanyaAngka(event)" autocomplete="off" value="<?= $key->isi_total; ?>">
                                                                                                    ...
                                                                                                    <td>
                                                                                                        ...
                                                                                                        foreach ($product as $prod) {
                                                                                                            if ($prod->szId == $key->masterKode) { ?>
                                                                                                                <input name="satuanTk[<?= $no; ?>]" type="text" id="idSatuanTk<?= $no; ?>" class="form-control" readonly value="<?= $prod->szUomId ?>">
                                                                                                        <?php
                                                                                                            }
                                                                                                        }
                                                                                                        ?>
                                                                                        ...
                                                                                        if ($key->ksg_total != '0') {
                                                                                            if ($key->masterKode == '42001' || $key->masterKode == '41012') { ?>
                                                                                                <tr>
                                                                                                    <td>
                                                                                                        <select class="js-example-basic-single form-select" name="kodeTk[<?= $no; ?>]" id="idKodeTk<?= $no; ?>" required onchange="getFormProdukTk(<?= $no; ?>)">
                                                                                                            <option value="-" disabled>Pilih Produk</option>
                                                                                                    ...
                                                                                                    <td>
                                                                                                        <input name="qtyTk[<?= $no; ?>]" type="text" id="idQtyTk<?= $no; ?>" class="form-control" onkeypress="return hanyaAngka(event)" autocomplete="off" value="<?= (int)$key->isi_total + (int)$key->ksg_total; ?>" required onchange="getBa(<?= $no; ?>)">
                                                                                                        <input name="qtyOldTk[<?= $no; ?>]" type="hidden" id="idQtyOldTk<?= $no; ?>" class="form-control" onkeypress="return hanyaAngka(event)" autocomplete="off" value="<?= (int)$key->isi_total + (int)$key->ksg_total; ?>">
    ...
    <script>
        ...
        function getFormProdukTk(x) {
            var produk = document.getElementById('idKodeTk' + x).value;
            ...
            $.ajax({
                ...
                success: function(data) {
                    for (var row of data) {
                        document.getElementById('idProdukTk' + x).value = row.szName;
                        document.getElementById('idSatuanTk' + x).value = row.szUomId;
                    }
                }
            })
        }
