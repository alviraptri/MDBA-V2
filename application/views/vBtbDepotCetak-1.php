...
<head>
    ...
    <title>BTB ANTARDEPO <?= $document; ?></title>
    <style>
        #table {
...
<body>
    ...
    <div style="text-align:center">
        <h3> BUKTI TERIMA BARANG ANTARDEPO</h3>
    </div>
    <?php
    foreach ($load as $value) {
        // echo "DATA <pre>".var_export($value, true)."</pre>";
        $gudangId = $value->szWarehouseId;
        $gudang = $value->gudang;
        $pengemudi = $value->szEmployeeId . ' - ' . $value->pengemudi;
        $kendaraan = $value->szVehicleId;
        $nopol = $value->kendaraan;
