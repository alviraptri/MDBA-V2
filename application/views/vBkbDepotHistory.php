   ...
   <!-- <script src="<?php echo base_url(); ?>assets/jquery/bootstrap.min.js"></script>-->
                        ...
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col-md-6" style="float: right;">
                                    <form action="<?php echo base_url('inventDepot/tglHistoryBkb') ?>" method="post">
                                ...
                                <tbody>
                                    ...
                                    foreach ($data as $value) { ?>
                                        <tr>
                                            ...
                                            <td><?= $value->dtmDoc; ?></td>
                                            <td>
                                                <!-- <a href="<?php echo base_url('inventDepot/editBkb/' . $value->szDocId); ?>">
                                                    <button type="button" class="btn icon btn-info">
                                                        Edit
                                                    </button>
                                                </a> -->
                                                <a href="<?php echo base_url('inventCetak/bkbDepot/' . $value->szDocId); ?>" target="_blank">
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-full" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel20">Detail BKB Depot</h4>
    ...
    <script>
        function detail(x) {
            ...
            function data() {
                $.ajax({
                    url: "<?= base_url('inventDepot/detailBkb') ?>",
                    method: "POST",
                    data: {
                        'id': id
                    },
