                        ...
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class='breadcrumb-header'>
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page"><a href="<?php echo base_url('home/bkbSupplier'); ?>">BKB Supplier</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                                    ...
                                    <div class="row d-flex justify-content-center">
                                        <div class="col-12">
                                            <div class="wizard">
                                                ...
                                                <form role="form" action="<?php echo base_url('inventSupp/tambahBkb'); ?>" method="POST" class="login-box" enctype="multipart/form-data">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <h4>Admin Depo</h4>
                                                                        <label>Return Isi</label>
                                                                        <input type="number" name="returnIsiAdm" id="returnIsiAdm" class="form-control" value="<?= $po_return_isi ?>">
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label>Jugrack</label>
                                                                        <input type="number" name="jugrackAdm" id="jugrackAdm" class="form-control" value="<?= $po_jugrack ?>">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="form-group col-md-6">
                                                                    <label>Palet</label>
                                                                    <input type="number" name="paletAdm" id="paletAdm" class="form-control" value="<?= $po_palet ?>">
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label>Galon Kosong</label>
                                                                        <input type="number" name="glnKosongAdm" id="glnKosongAdm" class="form-control" value="<?= $po_gal_kos ?>">
                                                                    </div>
                                                                </div>
                                                                <div class="form-group col-md-6">
                                                                    <label>Nopol</label>
                                                                ...
                                                                <div class="form-group col-md-6">
                                                                    <label>Nopol</label>
                                                                    <input type="text" name="nopolAdm" id="nopolAdm" class="form-control" value="<?= $po_nopol ?>">
                                                                </div>
                                                                <div class="form-group col-md-6">
                                                                    <label>Supir</label>
                                                                ...
                                                                <div class="form-group col-md-6">
                                                                    <label>Supir</label>
                                                                    <input type="text" name="driverAdm" id="driverAdm" class="form-control" value="<?= $po_driver ?>">
                                                                </div>
                                                                <div class="form-group col-md-6">
                                                                ...
                                                                <div class="form-group col-md-6">
                                                                    <label for="emailAddress">Supir Pengganti</label>
                                                                    <input type="text" name="driver2Adm" id="driver2Adm" class="form-control" value="<?= $po_driver_pengganti ?>">
                                                                </div>
                                                                <div class="form-group col-md-6">
                                                                ...
                                                                <div class="form-group col-md-6">
                                                                    <label for="emailAddress">Transporter</label>
                                                                    <input type="text" name="transporterAdm" id="transporterAdm" class="form-control" value="<?= $po_transporter_kode ?>">
                                                                </div>
                                                                <br>
                                                        ...
                                                        <div class="tab-pane" role="tabpanel" id="step2">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="form-group col-md-6">
                                                                    <h4>Admin Depo</h4>
                                                                    <label for="firstName">Hari</label>
                                                                    <input type="text" name="hariAdm" id="hariAdm" class="form-control" value="<?= $js_day ?>">
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <!-- <div class="form-group col-md-4">
                                                                ...
                                                                <div class="form-group col-md-6">
                                                                    <label for="emailAddress">Tanggal Window</label>
                                                                    <input type="text" name="tglWindowAdm" id="tglWindowAdm" class="form-control" value="<?= $js_date ?>">
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <!-- <div class="form-group col-md-4">
                                                                ...
                                                                <div class="form-group col-md-6">
                                                                    <label for="emailAddress">Pabrik Window</label>
                                                                    <input type="text" name="pabrikWindowAdm" id="pabrikWindowAdm" class="form-control" value="<?= $pabrik_nama ?>">
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <!-- <div class="form-group col-md-4">
                                                                ...
                                                                <div class="form-group col-md-6">
                                                                    <label for="emailAddress">Material</label>
                                                                    <input type="text" name="materialAdm" id="materialAdm" class="form-control" value="<?= $material_nama ?>">
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <!-- <div class="form-group col-md-4">
                                                                ...
                                                                <div class="form-group col-md-6">
                                                                    <label for="emailAddress">Tujuan Awal</label>
                                                                    <input type="text" name="tujuanAwalAdm" id="tujuanAwalAdm" class="form-control" value="<?= $js_tujuan_co ?>">
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <!-- <div class="form-group col-md-4">
                                                                ...
                                                                <div class="form-group col-md-6">
                                                                    <label for="emailAddress">Tujuan Final Depo</label>
                                                                    <input type="text" name="tujuanFinalAdm" id="tujuanFinalAdm" class="form-control" value="<?= $mk_masuk_tujuan ?>">
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <!-- <div class="form-group col-md-4">
                                                                ...
                                                                <div class="form-group col-md-6">
                                                                    <label for="emailAddress">Tujuan Final CO</label>
                                                                    <input type="text" name="tujuanCoAdm" id="TujuanCoAdm" class="form-control" value="<?= $mk_depo_tujuan ?>">
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="tab-pane" role="tabpanel" id="step3">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="form-group col-md-6">
                                                                    <h4>Admin Depo</h4>
                                                                    <label for="firstName">Dikirim Ke</label>
                                                                    <input type="text" name="sendAdm" id="sendAdm" class="form-control" value="<?= $js_tujuan_co ?>">
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <!-- <div class="form-group col-md-4">
                                                                ...
                                                                <div class="form-group col-md-4">
                                                                    <label for="firstName">Produk</label>
                                                                    <input type="text" name="produkGrAdm" id="produkGrAdm" class="form-control" value="<?= $material_nama ?>">
                                                                </div>
                                                                <div class="form-group col-md-2">
                                                                    <label for="firstName">Qty</label>
                                                                    <input type="number" name="qtyGrAdm" id="qtyGrAdm" class="form-control" value="<?= $mk_gr_qty ?>">
                                                                </div>
                                                                <br>
                                                                <div class="form-group col-md-6"></div>
                                                        ...
                                                        <div class="tab-pane" role="tabpanel" id="step4">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="form-group col-md-6">
                                                                    <h4>Admin Depo</h4>
                                                                    <label for="firstName">Tanggal DN</label>
                                                                    <input type="text" name="tglDnAdm" id="tglDnAdm" class="form-control" value="<?= $mk_dn_date ?>">
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <!-- <div class="form-group col-md-4">
                                                                ...
                                                                <div class="form-group col-md-6">
                                                                    <label for="firstName">Dikirim Ke</label>
                                                                    <input type="text" name="sendDnAdm" id="sendDnAdm" class="form-control" value="<?= $js_tujuan_co ?>">
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <!-- <div class="form-group col-md-4">
                                                                ...
                                                                <div class="form-group col-md-6">
                                                                    <label for="firstName">Pabrik</label>
                                                                    <input type="text" name="pabrikDnAdm" id="pabrikDnAdm" class="form-control" value="<?= $pabrik_nama ?>">
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <!-- <div class="form-group col-md-4">
                                                                ...
                                                                <div class="form-group col-md-6">
                                                                    <label for="firstName">Nopol</label>
                                                                    <input type="text" name="nopolDnAdm" id="nopolDnAdm" class="form-control" value="<?= $mk_dn_van ?>">
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <!-- <div class="form-group col-md-4">
                                                                ...
                                                                <div class="form-group col-md-6">
                                                                    <label for="firstName">Driver</label>
                                                                    <input type="text" name="driverDnAdm" id="driverDnAdm" class="form-control" value="<?= $po_driver ?>">
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <!-- <div class="form-group col-md-4">
                                                                ...
                                                                <div class="form-group col-md-4">
                                                                    <label for="firstName">Produk</label>
                                                                    <input type="text" name="produkGrDepo" id="produkDnDepo" class="form-control" readonly value="<?= $material_nama ?>">
                                                                </div>
                                                                <div class="form-group col-md-2">
                                                                    <label for="firstName">Qty</label>
                                                                    <input type="text" name="qtyGrDepo" id="qtyDnDepo" class="form-control" readonly value="<?= $mk_dn_m_qty ?>">
                                                                </div>
                                                                <div class="form-group col-md-4">
                                                                    <label for="firstName">Produk</label>
                                                                    <input type="text" name="produkGrAdm" id="produkDnAdm" class="form-control" value="<?= $material_nama ?>">
                                                                </div>
                                                                <div class="form-group col-md-2">
                                                                    <label for="firstName">Qty</label>
                                                                    <input type="number" name="qtyDnAdm" id="qtyDnAdm" class="form-control" value="<?= $mk_dn_m_qty ?>">
                                                                </div>
                                                                <br>
                                                                <div class="form-group col-md-6"></div>
                                                        ...
                                                        <div class="tab-pane" role="tabpanel" id="step5">
                                                            <div class="all-info-container">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-8">
                                                                        <div class="form-group row">
                                                                            <label class="col-2 col-form-label" for="bkb" style="font-size: 22px; font-weight: bold;">No. BKB</label>
                                                                            <div class="col-10">
                                                                    ...
                                                                    <div class="form-group col-md-12">
                                                                        <table class='table table-striped'>
                                                                            ...
                                                                            <tbody id="table_body">
                                                                                <tr>
                                                                                    <td>Return Isi</td>
                                                                                    <td><input type="text" name="smrCkrReturn" id="smrCkrReturn" class="form-control" value="<?= $po_return_isi ?>" readonly></td>
                                                                                    <td><input type="text" name="smrAdmReturn" id="smrAdmReturn" class="form-control" value="<?= $po_return_isi ?>" readonly></td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td>Jugrack</td>
                                                                                    <td><input type="text" name="smrCkrJugrack" id="smrCkrJugrack" class="form-control" value="<?= $po_jugrack ?>" readonly></td>
                                                                                    <td><input type="text" name="smrAdmJugrack" id="smrAdmJugrack" class="form-control" value="<?= $po_jugrack ?>" readonly></td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td>Palet</td>
                                                                                    <td><input type="text" name="smrCkrPalet" id="smrCkrPalet" class="form-control" value="<?= $po_palet ?>" readonly></td>
                                                                                    <td><input type="text" name="smrAdmPalet" id="smrAdmPalet" class="form-control" value="<?= $po_palet ?>" readonly></td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td>Galon Kosong</td>
                                                                                    <td><input type="text" name="smrCkrGalKos" id="smrCkrGalKos" class="form-control" value="<?= $po_gal_kos ?>" readonly></td>
                                                                                    <td><input type="text" name="smrAdmGalKos" id="smrAdmGalKos" class="form-control" value="<?= $po_gal_kos ?>" readonly></td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td>Good Return (GR)</td>
                                                                                    <td><input type="text" name="smrCkrGr" id="smrCkrGr" class="form-control" value="<?= $mk_gr_qty ?>" readonly></td>
                                                                                    <td><input type="text" name="smrAdmGr" id="smrAdmGr" class="form-control" value="<?= $mk_gr_qty ?>" readonly></td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td>Total DN</td>
                                                                                    <td><input type="text" name="smrCkrTotalDn" id="smrCkrTotalDn" class="form-control" value="<?= (int)$mk_dn_m_qty ?>" readonly></td>
                                                                                    <td><input type="text" name="smrAdmTotalDn" id="smrAdmTotalDn" class="form-control" value="<?= (int)$mk_dn_m_qty ?>" readonly></td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                    </div>
