                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        ...
                                        foreach ($data as $value) {
                                            $btb = $value->sumBkb;
                                            $pabrik = $value->coPabrik;
                                            $co = $value->coNo;
                                            $dn = $value->dnNo;
                                            $po = $value->poNo;
                                            $gr = $value->grNo;
                                            $dnTgl = $value->dnTanggal;
                                            $poNopol = $value->poNopol;
                                            $poSupir = $value->poSupir;
                                            $poSupirPengganti = $value->poSupirPengganti;
                                            if ($poSupirPengganti != '') {
                                                $supir = $poSupirPengganti;
                                            } else {
                                                $supir = $poSupir;
                                            }
                                            $transporter = $value->poTransporter;
                                            $btbTk = $value->dnDocumentTk;
                                        }
                                        ?>
                                        <form class="form" action="<?php echo base_url('inventSupp/simpanBtb'); ?>" method="POST">
                                            <div class="row">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-8" style="padding-left: 0;" id="pengemudiId">
                                                                ...
                                                                foreach ($employee as $value) {
                                                                    if ($supir == $value->szDriverName) {
                                                                        $driverName = $value->szDriverName;
                                                                    } else {
                                                                        $driverName = $supir;
                                                                    }
                                                                }
                                                                ?>
                                                                <input type="text" id="pengemudiNama" class="form-control" required name="namaPengemudi" value="<?= $driverName; ?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-8" style="padding-left: 0;" id="kendaraanId">
                                                                ...
                                                                foreach ($vehicle as $value) {
                                                                    if ($poNopol == $value->szVehicleNo) {
                                                                        $nopolName = $value->szVehicleNo;
                                                                    } else {
                                                                        $nopolName = $poNopol;
                                                                    }
                                                                }
                                                                ?>
                                                                <input type="text" id="kendaraanNama" class="form-control" name="namaKendaraan" required value="<?= $nopolName; ?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6 col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="hidden" id="idBtbTk" class="form-control" name="btbTk" required value="<?= $btbTk; ?>">
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <tbody id="table_body" class="view-this">
                                                            ...
                                                            ?>
                                                                <tr id="baris<?= $no; ?>">
                                                                    ...
                                                                    <td>
                                                                        <input name="qty[<?= $no; ?>]" type="text" id="idQty<?= $no; ?>" class="form-control" onkeypress="return hanyaAngka(event)" autocomplete="off" required value="<?= $prod->sumQty; ?>">
                                                                    </td>
                                                                    <td>
                                                                        <input name="satuan[<?= $no; ?>]" type="text" id="idSatuan<?= $no; ?>" class="form-control" readonly value="<?= $prod->sumSatuan; ?>">
                                                                    </td>
                                                                    <td>
                                                                        <?php
                                                                        if ($no == '0') {
