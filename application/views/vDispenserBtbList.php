...
<head>
    ...
    <title>MDBA - BTB Dispenser</title>
                        ...
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class='breadcrumb-header'>
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page"><a href="<?php echo base_url('home/bkbDispenser'); ?>">BTB Dispenser</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                        ...
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <a href="<?php echo base_url('bkbDispenser/manualBtb') ?>">
                                        <button type="submit" class="btn btn-white">Input</button>
                                    </a>
                                </div>
                                <div class="col-md-6" style="float: right;">
                                    <form action="<?php echo base_url('bkbDispenser/filterBtb') ?>" method="post">
