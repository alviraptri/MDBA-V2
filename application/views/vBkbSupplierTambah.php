                                                                    ...
                                                                    <div class="form-group col-md-12">
                                                                        <table class='table table-striped'>
                                                                            ...
                                                                            <tbody id="table_body">
                                                                                ...
                                                                                $no = 0;
                                                                                foreach ($data as $key) {
                                                                                    if ($key->mk_po_gal_kos != '0') {
                                                                                        if ($key->masterKode == '74559G' || $key->masterKode == '74560G') {
                                                                                ?>
                                                                                            <tr>
                                                                                                <td>
                                                                                                ...
                                                                                                <td>
                                                                                                    <input name="qty[<?= $no; ?>]" type="text" id="idQty<?= $no; ?>" class="form-control" onkeypress="return hanyaAngka(event)" autocomplete="off" value="<?= (int)$value->mk_po_gal_kos - (int)$value->mk_bs_depo; ?>" onchange="getBa(<?= $no; ?>)" required>
                                                                                                    <input name="qtyOld[<?= $no; ?>]" type="hidden" id="idQtyOld<?= $no; ?>" class="form-control" onkeypress="return hanyaAngka(event)" autocomplete="off" value="<?= $value->mk_po_gal_kos - (int)$value->mk_bs_depo; ?>">
                                                                                                </td>
                                                                                                <td>
                                                                                                    <?php
                                                                                                    foreach ($product as $prod) {
                                                                                    ...
                                                                                    if ($key->mk_jugrack != '0') {
                                                                                        ...
                                                                                        ?>
                                                                                            <tr>
                                                                                                ...
                                                                                                <td>
                                                                                                    <input name="qty[<?= $no; ?>]" type="text" id="idQty<?= $no; ?>" class="form-control" onkeypress="return hanyaAngka(event)" autocomplete="off" value="<?= (int)$value->mk_jugrack; ?>" required onchange="getBa(<?= $no; ?>)">
                                                                                                    <input name="qtyOld[<?= $no; ?>]" type="hidden" id="idQtyOld<?= $no; ?>" class="form-control" onkeypress="return hanyaAngka(event)" autocomplete="off" value="<?= (int)$value->mk_jugrack; ?>">
                                                                                                </td>
                                                                                                <td>
                                                                                                    <?php
                                                                                                    foreach ($product as $prod) {
                                                                                    ...
                                                                                    if ($key->mk_bs_depo != '0') {
                                                                                        if ($key->masterKode == '42001' || $key->masterKode == '41001' || $key->masterKode == '41012' || $key->masterKode == '41013') { ?>
                                                                                            <tr>
                                                                                                <td>
                                                                                                    <select class="js-example-basic-single form-select" name="kode[<?= $no; ?>]" id="idKode<?= $no; ?>" required onchange="getFormProduk(<?= $no; ?>)">
                                                                                                        <option value="-" disabled>Pilih Produk</option>
                                                                                                ...
                                                                                                <td>
                                                                                                    <input name="qty[<?= $no; ?>]" type="text" id="idQty<?= $no; ?>" class="form-control" onkeypress="return hanyaAngka(event)" autocomplete="off" value="<?= $value->mk_bs_depo; ?>" required onchange="getBa(<?= $no; ?>)">
                                                                                                    <input name="qtyOld[<?= $no; ?>]" type="hidden" id="idQtyOld<?= $no; ?>" class="form-control" onkeypress="return hanyaAngka(event)" autocomplete="off" value="<?= $value->mk_bs_depo; ?>">
