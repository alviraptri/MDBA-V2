    ...
    <?php } else if ($this->session->flashdata('info')) { ?>
        <script>
            Swal.fire({
                type: 'info',
                title: 'Data Berhasil Tersimpan',
                text: 'Apakah ingin menambahkan PB?',
                ...
                if (result.value == true) {
                    $.ajax({
                        success: function() {
                            location.href = "<?= base_url('sndPB/manualPB'); ?>"
                        }
                    });
                } else {
                    $.ajax({
                        success: function() {
                            location.href = "<?= base_url('inventDist/historyBkb'); ?>"
                        }
                    });
                }
            })
                            ...
                            <nav aria-label="breadcrumb" class='breadcrumb-header'>
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">
                                        <a href="<?php echo base_url('home/bkbDistribusi'); ?>">BKB Distribusi</a>
                                    </li>
                                </ol>
                            </nav>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Edit BKB Distribusi</h4>
                                </div>
                                <div class="card-content">
                                    <div class="card-body">
                                        ...
                                        foreach ($data as $value) {
                                            ...
                                            $pb = $value->szDocPRId;
                                            $bkbOld = $value->szDocId;
                                            $tanggal = $value->dtmDoc;
                                        }
                                        ?>
                                        <form class="form" id="formId" action="<?php echo base_url('inventDist/updateBkb'); ?>" method="POST">
                                            <div class="row">
                                                <div class="col-md-4 col-12">
                                                    <div class="form-group">
                                                        <label for="last-name-column">No. BKB Lama</label>
                                                        <input type="text" id="noDoc" class="form-control" name="bkbOld" readonly value="<?= $bkbOld; ?>">
                                                        <input type="hidden" id="noPb" class="form-control" name="pbOld" readonly value="<?= $pb; ?>">
                                                    </div>
                                                </div>
                                                <div class="col-md-4 col-12">
                                                    <div class="form-group">
                                                        <label for="last-name-column">No. BKB Pembatal</label>
                                                        <input type="text" id="noDoc" class="form-control" name="bkbCancel" readonly value="<?= $bkb; ?>">
                                                    </div>
                                                </div>
                                                <div class="col-md-4 col-12">
                                                    <div class="form-group">
