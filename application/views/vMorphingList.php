...
<body>
                        ...
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <a href="<?php echo base_url('inventori/historyMorphing') ?>">
                                        <button type="submit" class="btn btn-secondary">History</button>
                                    </a>
                                    <a href="<?php echo base_url('inventori/manualMorphing') ?>">
                                ...
                                <tbody>
                                    ...
                                    foreach ($data as $value) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <!-- <input type="hidden" name="a" id="<?= $no; ?>" value="<?= $value->doc_id; ?>">
                                                <button type="button" class="btn btn-info" onclick="detail(document.getElementById('<?= $no; ?>').value)">
                                                    Detail
                                                </button> -->
                                                <a href="<?php echo base_url('inventori/tambahMorphing/' . $value->doc_id); ?>">
                ...
                <div class="modal-body">
                    <form class="form">
                        <div class="row">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    <label for="city-column">DISTRIBUSI</label>
                                    <input type="text" id="idDISTRIBUSI" class="form-control" placeholder="City" name="DISTRIBUSI" readonly>
                                </div>
                            </div>
                            <div class="col-md-6 col-12">
                                <div class="form-group">
    ...
    <script>
        function detail(x) {
            ...
            function data() {
                $.ajax({
                    url: "<?= base_url('inventori/getDetBtbDISTRIBUSI') ?>",
                    method: "POST",
                    data: {
                        'id': id
                    },
                    ...
                    success: function(data) {
                        ...
                        for (i = 0; i < data.btb.length; i++) {
                            document.getElementById("idDISTRIBUSI").value = data.btb[i].pabrik_nama;
