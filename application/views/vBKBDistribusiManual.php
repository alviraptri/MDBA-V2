...
<body>
                                                            ...
                                                            <tbody id="table_body" class="view-this">
                                                                ...
                                                                foreach ($data as $prod) { ?>
                                                                    <tr id="baris<?= $no; ?>">
                                                                        ...
                                                                        <td>
                                                                            <input name="qty[]" type="text" id="idQty<?= $no; ?>" value="<?= (int)$prod->decQty; ?>" class="form-control" onkeypress="return hanyaAngka(event)" required onchange="getInfo(<?= $no; ?>)" autocomplete="off">
                                                                            <input name="onHand[]" type="hidden" id="idOnHand<?= $no; ?>" value="<?= $prod->decQtyOnHand; ?>" class="form-control" onkeypress="return hanyaAngka(event)" autocomplete="off">
                                                                            <label id="notif<?= $no; ?>" style="color: red;">*Qty Lebih Besar dari Stok</label>
                                                                        </td>
                                                                        <td>
    ...
    <script type="text/javascript">
        ...
        function loadnew(e) {
            ...
            cols += "</td>";
            cols += "<td>";
            cols += "<input name='qty[" + count + "]' type='text' id='idQty" + count + "' class='form-control' onkeypress='return hanyaAngka(event)' required onchange='getInfo(" + count + ")' autocomplete='off'>";
