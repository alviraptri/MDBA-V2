...
<body>
                                        ...
                                        <form class="form" id="formId" action="<?php echo base_url('inventDepot/simpanBkb'); ?>" method="POST">
                                            <div class="row">
                                                ...
                                                foreach ($data as $value) {
                                                    $referensi = $value->no_pengajuan;
                                                    $tanggal = $value->tanggal_kebutuhan;
                                                    $tujuan = $value->depo_tujuan;
                                                    $tujuanNama = $value->depo;
                                                    $status = $value->status_sa;
                                                    $pengemudiNama = $value->driver;
                                                    $kendaraanNama = $value->nopol;
                                                ...
                                                <div class="col-md-3 col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="idRef" class="form-control" name="referensi" readonly value="<?= $referensi; ?>">
                                                        <input type="hidden" id="idStatus" class="form-control" name="status" readonly value="<?= $status; ?>">
                                                    </div>
                                                </div>
                                                <div class="col-md-2 col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <label for="last-name-column">Tujuan</label>
                                                            <div class="row">
                                                                <div class="col-4" style="padding-right: 0">
                                                                    ...
                                                                    <select class="js-example-basic-single col-md-2 form-select" name="depo" id="idDepo" onchange="getFormDepoTujuan()">
                                                                        <option value="-" disabled>Pilih Depo</option>
                                                                        <option value=""></option>
                                                                        <?php
                                                                        foreach ($branch as $value) {
                                                                            if ($value->szId == $tujuan) { ?>
                                                                ...
                                                                <div class="col-8" style="padding-left: 0;">
                                                                    <input type="text" id="namaDepo" class="form-control" name="depoNama" readonly value="<?= $tujuanNama; ?>">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-12" style="padding-right: 0">
                                                                <select class="js-example-basic-single col-md-6 form-select" name="kendaraan" id="idKendaraan" onchange="getFormKendaraan()">
                                                                    ...
                                                                    foreach ($vehicle as $value) {
                                                                        if ($value->szPoliceNo == $kendaraanNama) { ?>
                                                                            <option value="<?= $value->szId; ?>" selected><?= $value->szId; ?> - <?= $value->szName; ?></option>
                                                                        <?php } else { ?>
                                                                            <option value="<?= $value->szId; ?>"><?= $value->szId; ?> - <?= $value->szName; ?></option>
                                                                    <?php }
                                                            ...
                                                            $no = 0;
                                                                foreach ($data as $prod) { ?>
                                                                    <tr id="baris<?= $no; ?>">
                                                                        ...
                                                                        <!-- <td>
                                                                            <input name="produk[<?= $no; ?>]" type="text" id="idProduk<?= $no; ?>" class="form-control" readonly value="<?= $prod->pdNama; ?>">
                                                                        </td> -->
                                                                        <td>
                                                                            <input name="qty[<?= $no; ?>]" type="text" id="idQty<?= $no; ?>" class="form-control" onkeypress="return hanyaAngka(event)" autocomplete="off" required value="<?= $prod->quantity; ?>">
                                                                        </td>
                                                                        <td>
    ...
    <script>
        function getFormSoTujuan() {
            ...
            $.ajax({
                url: "<?= base_url('inventDepot/getSoName') ?>",
                method: "POST",
                data: {
                    id: id
                },
                ...
                success: function(data) {
                    for (var row of data) {
                        document.getElementById('namaSo').value = row.szName;
                    }
                }
            })
        }
        ...
        function getFormDepoTujuan() {
            var id = document.getElementById('idDepo').value;
            ...
            $.ajax({
                ...
                success: function(data) {
                    for (var row of data) {
                        document.getElementById('namaDepo').value = row.szName;
                    }
                }
            })
