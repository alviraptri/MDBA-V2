...
<body>
                ...
                <section class="section">
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-6">
                                    <a href="<?php echo base_url('home/bkbSupplier') ?>">
                                        <button type="submit" class="btn btn-success">Back</button>
                                    </a>
                                    <button type="submit" class="btn btn-warning" onClick="refresh(this)">Refresh</button>
                                </div>
                                <div class="col-md-6" style="float: right;">
                                    <form action="<?php echo base_url('inventSupp/tglHistoryBkb') ?>" method="post">
                                ...
                                <tbody>
                                    ...
                                    foreach ($data as $value) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <!-- <a href="<?php echo base_url('inventSupp/editBkb/' . $value->szDocId); ?>">
                                                    <button type="button" class="btn icon btn-info">
                                                        Edit
                                                    </button>
                                                </a> -->
                                                <a href="<?php echo base_url('inventCetak/bkbSupplier/' . $value->szDocId); ?>" target="_blank">
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-full" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel20">Detail BKB Supplier</h4>
    ...
    <script>
        function detail(x) {
            ...
            function data() {
                $.ajax({
                    url: "<?= base_url('inventSupp/detailBkb') ?>",
                    method: "POST",
                    data: {
                        'id': id
                    },
