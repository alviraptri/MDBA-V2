                        ...
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <a href="<?php echo base_url('inventori/btbDistribusiSpsHistory') ?>">
                                ...
                                <tbody>
                                    ...
                                    foreach ($waterout as $value) { ?>
                                        <tr>
                                            ...
                                            <td><?= $value->driver; ?></td>
                                            <td>
                                                <!-- <input type="hidden" name="a" id="<?= $no; ?>" value="<?= $value->no_bkb; ?>">
                                                <button type="button" class="btn btn-info" onclick="detail(document.getElementById('<?= $no; ?>').value)">
                                                    Detail
                                                </button> -->
                                                <a href="<?php echo base_url('inventori/tambahBtbDistribusiSps/' . $value->no_bkb); ?>">
