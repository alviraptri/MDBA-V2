...
<body>
                        ...
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col-md-6" style="float: right;">
                                    <form action="<?php echo base_url('inventori/tglHistoryBtbDist') ?>" method="post">
                                ...
                                <tbody>
                                    ...
                                    foreach ($a as $value) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?php echo base_url('inventori/editBtbDistribusiSps/' . $value->szDocId); ?>">
                                                    <button type="button" class="btn icon btn-info">
                                                        Edit
                                                    </button>
                                                </a>
                                                <a href="<?php echo base_url('inventori/cetakBtbDistribusi/' . $value->szDocId); ?>" target="_blank">
    ...
    <script>
        function detail(x) {
            ...
            function data() {
                $.ajax({
                    url: "<?= base_url('inventori/detailBtbDistribusi') ?>",
                    method: "POST",
                    data: {
                        'id': id
                    },
                    ...
                    success: function(data) {
                        ...
                        for (var row of data) {
                            ...
                            document.getElementById("idNoBkb").value = row.refNoBkb;
