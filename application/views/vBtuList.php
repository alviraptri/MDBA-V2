...
<body>
                        ...
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class='breadcrumb-header'>
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page"><a href="<?php echo base_url('home/cashierBTU'); ?>">Bukti Terima Uang (BTU)</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                        ...
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <a href="<?php echo base_url('cashierBtu/manualBtu') ?>">
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-full" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel20">Detail Bukti Terima Uang (BTU)</h4>
                        ...
                        <div class="row">
                            <div class="col-md-5 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="idBtu" class="form-control" name="btu" readonly>
                                </div>
                            </div>
                            <div class="col-md-5 col-12">
                                <div class="form-group">
    ...
    <script>
        function detail(x) {
            ...
            function data() {
                $.ajax({
                    url: "<?= base_url('cashierBtu/detailBtu') ?>",
                    method: "POST",
                    data: {
                        'id': id
                    },
                    ...
                    success: function(data) {
                        console.log(data);
                        for (var row of data) {
                            document.getElementById("idBtu").value = row.szDocId;
