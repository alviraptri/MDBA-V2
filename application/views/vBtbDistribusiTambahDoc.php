                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <form class="form" action="<?php echo base_url('inventDist/simpanBtbDoc'); ?>" method="POST">
                                            <?php
                                            foreach ($header as $value) {
                                                $bkb = $value->szDocBkb;
                                                $btb = $value->szDocId;
                                                $pengemudi = $value->szEmployeeId;
                                                $pengemudiNama = $value->employee;
                                                $kendaraan = $value->szVehicleId;
                                                $kendaraanNama = $value->vehicle;
                                                $gudang = $value->szWarehouseId;
                                                $gudangNama = $value->gudang;
                                                $stok = $value->szStockType;
                                                $stokNama = $value->stock;
                                            }
                                            ?>
                                            <div class="row">
                                                ...
                                                <div class="col-md-12 col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="keterangan" class="form-control" id="keterangan" cols="20" rows="3" required></textarea>
                                                    </div>
                                                </div>
                                                <div class="col-md-12 col-12">
                                                            ...
                                                            foreach ($detail as $prod) { ?>
                                                                <tr id="baris<?= $no; ?>">
                                                                    ...
                                                                    <!-- <td>
                                                                        ...
                                                                        <input type="text" id="idProduk" class="form-control" name="produk[<?= $no; ?>]" readonly value="<?= $prod->szName; ?>">
                                                                    </td> -->
                                                                    <td>
                                                                        <input name="qty[]" type="text" id="idQty<?= $no; ?>" value="<?= $prod->sumQty; ?>" class="form-control">
                                                                    </td>
                                                                    <td>
                                                                        <input name="satuan[]" type="text" id="idSatuan<?= $no; ?>" value="<?= $prod->sumSatuan; ?>" readonly class="form-control">
                                                                    </td>
                                                                    <td>
                                                                    <?php
                                                                            if ($no == '0') {
