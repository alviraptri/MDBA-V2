...
<head>
    ...
    <title>MDBA - BKB DISTRIBUSI HISTORY</title>
...
<body>
                        ...
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <a href="<?php echo base_url('inventDist/historyAdjBkb') ?>">
                                        <button type="submit" class="btn btn-adjustment">Adjustment History</button>
                                    </a>
                                </div>
                                <div class="col-md-6" style="float: right;">
                                    <form action="<?php echo base_url('inventDist/tglHistoryBkb') ?>" method="post">
                                ...
                                <tbody>
                                    ...
                                    foreach ($data as $value) { ?>
                                        <tr>
                                            ...
                                            <td><?= $value->szDocId; ?></td>
                                            <!-- <td><?= $value->refOld; ?></td> -->
                                            <td><?= $value->szDocPRId; ?></td>
                                            <td><?= $value->dtmDoc; ?></td>
                                            <td>
                                                <a href="<?php echo base_url('inventDist/editBkb/' . $value->szDocId); ?>">
                                                    <button type="button" class="btn icon btn-info">
                                                        Adjust
                                                    </button>
                                                </a>
                                                <a href="<?php echo base_url('inventCetak/bkbDistribusi/' . $value->szDocId); ?>" target="_blank">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="idNoRef" class="form-control" name="noRef" readonly>
                                </div>
                            </div>
    ...
    <script>
        function detail(x) {
            ...
            function data() {
                $.ajax({
                    url: "<?= base_url('inventDist/detailBkb') ?>",
                    method: "POST",
                    data: {
                        'id': id
                    },
                    ...
                    success: function(data) {
                        console.log(data);
                        for (var row of data) {
                            document.getElementById("idNoBkb").value = row.szDocId;
                            ...
                            document.getElementById("idKendaraan").value = row.szVehicleId + " - " + row.vehicleName;
                            document.getElementById("idPengemudi").value = row.szEmployeeId + " - " + row.employeeName;
                        }
