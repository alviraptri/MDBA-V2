...
<head>
    ...
    <title>MDBA - BUKTI KELUAR UANG (BKU)</title>
...
<body>
                ...
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last">
                            <h3>BUKTI KELUAR UANG (BKU)</h3>
                        </div>
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class='breadcrumb-header'>
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="<?php echo base_url('home'); ?>">Dashboard</a></li>
                                    <li class="breadcrumb-item active" aria-current="page"><a href="<?php echo base_url('home/cashierBKU'); ?>">Bukti Keluar Uang (BKU)</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                        ...
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <a href="<?php echo base_url('cashierBku/manualBku') ?>">
                                        <button type="submit" class="btn btn-white">Manual Input</button>
                                    </a>
                                </div>
                            </div>
                        </div>
                                    ...
                                    if ($data != 0) {
                                        foreach ($data as $value) { ?>
                                            <tr>
                                                ...
                                                <td><?= $value->szDocId; ?></td>
                                                <td><?= $value->dtmDoc; ?></td>
                                                <td><?= $value->szEmployeeId; ?> - <?= $value->employee; ?></td>
                                                <td>Rp <?= $value->decAmountControl; ?></td>
                                                <td>
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-full" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel20">Detail Bukti Keluar Uang (BKU)</h4>
                        ...
                        <div class="row">
                            <div class="col-md-5 col-12">
                                <div class="form-group">
                                    <label for="first-name-column">No. BKU</label>
                                    <input type="text" id="idBku" class="form-control" name="bku" readonly>
                                </div>
                            </div>
                            <div class="col-md-5 col-12">
                                <div class="form-group">
                                    <label for="last-name-column">No. Voucher</label>
                                    <input type="text" id="idVoucher" class="form-control" name="voucher" readonly>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-4" style="padding-right: 0">
                                            <input type="text" id="idAkun" class="form-control" name="akun" readonly>
                                        </div>
                                        <div class="col-8" style="padding-left: 0;">
                                            <input type="text" id="namaAkun" class="form-control" name="akunNama" readonly>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-4" style="padding-right: 0">
                                            <input type="text" id="idSubAkun" class="form-control" name="subAkun" readonly>
                                        </div>
                                        <div class="col-8" style="padding-left: 0;">
                                            <input type="text" id="namaSubAkun" class="form-control" name="subAkunNama" readonly>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="idTtlJumlah" class="form-control" name="ttlJumlah" readonly>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        function detail(x) {
            ...
            function data() {
                $.ajax({
                    url: "<?= base_url('cashierBku/detailBku') ?>",
                    method: "POST",
                    data: {
                        'id': id
                    },
                    ...
                    success: function(data) {
                        console.log(data);
                        for (var row of data) {
                            document.getElementById("idBku").value = row.szDocId;
                            document.getElementById("idVoucher").value = row.szVoucherNo;
                            document.getElementById("idTanggal").value = row.dtmDoc;
                            document.getElementById("idAkun").value = row.szAccountId;
                            document.getElementById("namaAkun").value = row.namaAkun;
                            document.getElementById("idSubAkun").value = row.szSubAccountId;
                            document.getElementById("namaSubAkun").value = row.namaSubAkun;
                            document.getElementById("idPengemudi").value = row.szEmployeeId;
                            document.getElementById("namaPengemudi").value = row.employee;
                            document.getElementById("idTtlJumlah").value = 'Rp ' + row.decAmountControl;
                        }
                        ...
                        for (i = 0; i < data.length; i++) {
                            html += '<tr>' +
                                '<td>' + number + '</td>' +
                                '<td>' + data[i].akunDet + '</td>' +
                                '<td>' + data[i].namaAkunDet + '</td>' +
                                '<td>' + data[i].subAkunDet + '</td>' +
                                '<td>' + data[i].namaSubAkunDet + '</td>' +
                                '<td>Rp ' + data[i].decAmount + '</td>' +
                                '<td>' + data[i].szDescription + '</td>' +
                                '<tr>';
                            number++;
                        }
